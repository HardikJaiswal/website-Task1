...
function noResultFound(){
  _resultPanel.innerHTML = `<div><img src="./images/zero-result.jpg" style="width: 150px;"></div>
...
function createEmployee(staff = undefined){
  if(typeof staff === 'undefined'){
    ...
    if(val1!=="" && val2!=="" && val3!=="" && val7!==""){
      let newEmployee = new Employee(val1,val2,val3,val4,val5,val6,val7,val8,index++);
...
function DisplayEmployee(staff){
  ...
  info.innerHTML = 
    ...
    <button onclick="hideInfo()" style="color: white;background-color: rgba(255, 0, 0, 0.555)">X</button><br><br>` +
